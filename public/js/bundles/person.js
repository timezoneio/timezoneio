...
},{"./views/person.jsx":3,"react":150}],3:[function(require,module,exports){
/** @jsx React.DOM */
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "container person-container"}, 
        ...
        React.createElement("img", {src: person.avatar, className: "avatar large"}), 

        React.createElement("h2", {className: "person-name"}, person.name), 

        React.createElement("h3", {className: "person-city"}, person.location)
...
},{"../components/header.jsx":1,"react":150}],4:[function(require,module,exports){
